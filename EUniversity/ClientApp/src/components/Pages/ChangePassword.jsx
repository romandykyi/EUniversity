  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'currentPassword' && !value) {
      ...
      if (isLengthValid && hasUpperCase && hasNumber && hasDistinctSymbols) {
        ...
        if (!hasDistinctSymbols)
          errorMessage += 'Contain at least 3 distinct symbols\n';
        setIsButtonDisabled(true);
        ...
        <div className='changePassword__inputs form__inputs'>
          ...
          <div className='changePassword__checkboxDiv mt-1'>
            <input
              ...
              id='showPassword1'
            />
            <label className='form-check-label' htmlFor='showPassword1'>
              show password
            </label>
          </div>
          <input
          ...
          <div className='changePassword__error form__error'>{error}</div>
        </div>
