...
const Login = () => {
  ...
  return (
    <div className='login form container max-w-[1100px] pt-10'>
      <h1 className='login__title form__title'>Log in to your account</h1>
      <form onSubmit={handleSubmit} className='login__form form__form'>
        <div className='login__inputs form__inputs'>
          ...
          />
          <div
            className='login__checkboxDiv form__checkboxDiv'
        ...
        <div className='login__error form__error'>{error}</div>
