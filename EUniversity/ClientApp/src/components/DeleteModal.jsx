        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-5">
                    <Button onClick={() => deleteFunction(deletedItem.id)} className="bg-danger px-3 py-2 font-medium text-white text-xl rounded-lg outline-none border-none transition-transform duration-200 cursor-pointer hover:bg-red-600 active:transform-active disabled:bg-gray-500 disabled:cursor-not-allowed disabled:active:transform-none">Delete</Button>
