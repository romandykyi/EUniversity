...
const EditFormModal = ({ item, isEditable, setIsEditable, responseTitle }) => {
  ...
  useEffect(() => {
    if (durationRef.current)
      durationRef.current.defaultValue = editedItem.duration.slice(0, -3);
    if (startDateRef.current)
      startDateRef.current.defaultValue = convertTimeFormat(
        editedItem.startDate,
        'date',
      );
    if (startTimeRef.current)
      startTimeRef.current.defaultValue = convertTimeFormat(
        editedItem.startDate,
        'time',
      );
    if (semesterDateFromRef.current)
      semesterDateFromRef.current.defaultValue = convertTimeFormat(
        editedItem.dateFrom,
        'date',
      );
    if (semesterDateToRef.current)
      semesterDateToRef.current.defaultValue = convertTimeFormat(
        editedItem.dateTo,
        'date',
      );
  });
          ...
          <tr>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'email', e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'firstName', e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'lastName', e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'middleName', e.target.value)
                }
              />
            </td>
            <td>
              <select
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'role', e.target.value)
                }
              >
          ...
          <tr>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'name', e.target.value)
                }
              />
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'dateFrom', e.target.value)
                }
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'dateTo', e.target.value)
                }
              />
            </td>
          </tr>,
          ...
          <tr>
            ...
            <td>
              <input
                ...
                ref={startDateRef}
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'startDate', e.target.value)
                }
              />
            </td>
            <td>
              <input
                type='time'
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'startTime', e.target.value)
                }
                ref={startTimeRef}
              />
            </td>
            <td>
              <input
                ...
                onChange={(e) =>
                  handleInputChange(editedItem.id, 'duration', e.target.value)
                }
  ...
  const putItems = async () => {
    ...
    if (responseTitle === 'groups') {
      postItem = {
        ...
        courseId:
          typeof editedItem.course !== 'object'
            ? editedItem.course
            : editedItem.course.id,
        teacherId:
          typeof editedItem.teacher !== 'object'
            ? editedItem.teacher
            : editedItem.teacher.id,
      };
      ...
      postItem = {
        classTypeId:
          typeof editedItem.classType !== 'object'
            ? editedItem.classType
            : editedItem.classType.id,
        classroomId:
          typeof editedItem.classroom !== 'object'
            ? editedItem.classroom
            : editedItem.classroom.id,
        groupId:
          typeof editedItem.group !== 'object'
            ? editedItem.group
            : editedItem.group.id,
        startDate: convertDateFormat(
          `${
            editedItem.startTime
              ? ` ${editedItem.startTime} ${editedItem.startDate}`
              : editedItem.startDate
          }`,
        ),
        duration:
          editedItem.duration.length < 8
            ? `${editedItem.duration}:00`
            : editedItem.duration,
      };
  ...
  const convertDateFormat = (inputDateString) => {
    ...
    const outputDateString = `${year}-${month < 10 ? '0' : ''}${month}-${
      day < 10 ? '0' : ''
    }${day}T${hours < 10 ? '0' : ''}${hours}:${
      minutes < 10 ? '0' : ''
    }${minutes}:${seconds < 10 ? '0' : ''}${seconds}.${milliseconds}Z`;
    ...
    >
      ...
      >
        ...
        <div className='table-container w-full'>
          <table
            className={`table w-full table-hover ${
